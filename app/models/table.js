...
// for(var p in TableSchema.paths){
//     TableSchema.path(p).required(true);
// }
...
TableSchema.path('clientFirstName').required(true, 'Table clientFirstName cannot be blank');
TableSchema.path('clientMiddleName').required(true, 'Table clientMiddleName cannot be blank');
TableSchema.path('clientLastName').required(true, 'Table clientLastName cannot be blank');
